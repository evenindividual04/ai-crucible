...
/**
 * Card component with glass morphism and hover effects
    ...
    "rounded-lg transition-all duration-200",
    {
        variants: {
            variant: {
                ...
                interactive: "bg-surface border border-border hover:border-border-hover hover:shadow-md cursor-pointer",
            },
            padding: {
                none: "",
                sm: "p-3",
